...
class App extends Component {
  ...
  render() {
    return (
      <div className="App">
        <Header
          revealFavourites={this.revealFavourites}
          returnPetsByLocation={this.returnPetsByLocation}
          makeVisible={this.makeVisible}
          setDisplayType={this.setDisplayType}
          visibleState={this.state.visible}
          menuSearchVisible={this.state.menuSearchVisible}
          revealMenuSearch={this.revealMenuSearch}
          getRandomPet={this.getRandomPet}
        />
        <main>
          <LocationSearchForm
            returnPetsByLocation={this.returnPetsByLocation}
          ...
          <span
            className={
              this.state.menuSearchVisible === true ? "hidden" : "active"
            }
          >
            OR
          </span>
          ...
          <RandomPetButton
            getRandomPet={this.getRandomPet}
            makeVisible={this.makeVisible}
            displayType={this.setDisplayType}
            revealMenuSearch={this.revealMenuSearch}
            menuSearchVisible={this.state.menuSearchVisible}
          />
          ...
          <Gallery
            ...
            randomPet={this.state.randomPet}
            showMorePetInfo={this.showMorePetInfo}
            displayPetProfile={this.displayPetProfile}
            visibleState={this.state.visible}
          ...
          <PetProfile
            ...
            petProfileActive={this.state.petProfileActive}
            closePetProfile={this.closePetProfile}
            addToFavourites={this.addToFavourites}
          />
        </main>
        ...
        <Favourites
          ...
          closeFavourites={this.closeFavourites}
          displayPetProfile={this.displayPetProfile}
          closePetProfile={this.closePetProfile}
        />
      </div>
