    ...
    return (
      <section
        className={`favourites ${
          this.props.favouritesActive === true
            ? "expand-favourites"
            : "close-favourites"
        }`}
      >
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() => {
                      this.props.removeFromFavourites(pet[0]);
                    }}
                    id={pet[0]}
                  >
                    Remove
        ...
        {this.state.showProfile === true ? (
          <FavouriteProfile
            petKey={this.state.key}
            favouritePets={this.props.favouritePets}
            hideFavouriteProfile={this.hideFavouriteProfile}
          />
        ) : null}
      </section>
    );
